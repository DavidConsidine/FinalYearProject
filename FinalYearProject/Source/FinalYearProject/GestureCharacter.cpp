...
void AGestureCharacter::Tick(float DeltaTime)
{
...
void AGestureCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// gesture move
	PlayerInputComponent->BindAxis("MoveForwardGesture", this, &AGestureCharacter::GestureMoveForward);
}
...
void AGestureCharacter::MoveForward(float Value)
{
	if (Value != 0.0f)
	{
...
void AGestureCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
